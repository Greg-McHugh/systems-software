...
void proceduredeclaration(int l, int *tx, int *dx);
...
void proceduredeclaration(int l, int *ptx, int *pdx) {
  if(token == 2) { // identifier
      enter(ptx, pdx, l, 3); // procedure
      get();
  }
  else {
...
{
  int lex = l;
  int base; //find base L levels down
  base = b;
